...
public class SegmentScript : MonoBehaviour {
	...
	void Start () {
        ...
        arm = this.transform.FindChild("Arm");
        joint = this.transform.FindChild("Joint");
    ...
    public void SetArmLength() {
        ...
        armLength = GameObject.Find("GM").GetComponent<ArmLogicScript>().armLength;
        Vector2 newScale = new Vector2(0.15f, armLength);
        arm.transform.localScale = newScale;
        arm.transform.localPosition = new Vector2(0.0f, (armLength / 2.0f));
    }
